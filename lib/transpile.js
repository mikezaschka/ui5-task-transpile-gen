...
module.exports = async function ({
     ...
     */
    async function handleRuntime(componentResource) {
     
        const toPath = componentResource.getPath();
        const pathPrefix = toPath.replace(preloadFileName, "");
        ...
        console.info("\n" + baseLogTask + "Add regenerator-runtime ".green + pathregen + emoji.get('palm_tree'));
