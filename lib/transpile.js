...
module.exports = async function ({
    ...
    const preloadFileName = parameters.options.configuration.preloadFileName || "Component.js"
    
    console.info("\n" + baseLogTask + "Add regenerator-runtime".green + emoji.get('palm_tree'));
    //get path of Component
    const componentResource = jsResources.find((jsResource) => jsResource.getPath().includes(preloadFileName));
